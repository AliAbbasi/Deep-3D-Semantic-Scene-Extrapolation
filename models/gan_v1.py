...
classes_count         = 14
scene_3d_shape        = [84, 44, 84] 
halfed_scene_3d_shape = scene_shape[2] / 2  
scene_2d_shape        = [84, 84] 
halfed_scene_2d_shape = scene_shape[1] / 2 
directory             = 'gan_v1'
to_train              = True
to_restore            = False
show_accuracy         = True
...
subset_train          = False 
train_3d_directory    = 'house_2/' 
train_2d_directory    = 'house_2d/' 
test_3d_directory     = 'house_2/'
...
def dilation_conv2d(x, w, b, name="d_conv2d", d_rate=1):
    with tf.name_scope(name): 
...
class ConvNet(object):
    ...
    def discriminator(self):
        # 3d:
        # global dis take first half + generated part(and real sec part) 
        # local dis takes generated part(and real sec part)
        # get the probability from local concat global part for 3d
        
        
        # 2d:
        # project the generated part(and real sec part) on 2D and gets its probability
    ...
    def generator(self):  
        ...
        # encoder_3d  .. . . . .. .  
        # encoder_2d .. .. . . .. 
        # create latent from 3d and 2d encoder 
        # give it to generator
