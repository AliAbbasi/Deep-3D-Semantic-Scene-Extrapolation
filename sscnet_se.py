...
class ConvNet( object ):
    ...
    def paramsFun(self): 
        params_w = {
                    'w1'    : tf.Variable(tf.truncated_normal( [ 7 , 7 , 7 , 30  , 16    ], stddev = 0.01 )),  
                    ...
                    'wOut'  : tf.Variable(tf.truncated_normal( [ 1 , 1 , 1 , 128 , 14*30 ], stddev = 0.01 ))
                   }
        ...
        params_b = {
                    ...
                    'bOut'  : tf.Variable(tf.truncated_normal( [ 14*30 ], stddev = 0.01 ))
                   }
    ...
    def scoreFun(self): 
        ...
        concat    = tf.concat ( axis=3, values=[merge_4, merge_3, merge_5] ) 
        
        convT_12  = conv3d_transpose( concat,   self.params_w_['w12'],  self.params_b_['b12'], [self.batchSize, 13, 15, 128], strides=2 )
        convT_13  = conv3d_transpose( convT_12, self.params_w_['w13'],  self.params_b_['b13'], [self.batchSize, 26, 30, 128], strides=2 )
